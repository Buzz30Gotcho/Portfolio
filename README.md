...
<img src="qui_est_ce.jpg" alt="Qui est-ce Screenshot" width="300" height="400">
...
## 📚 Compétences
- **Langages :** JavaScript, TypeScript, Python, HTML, CSS, Java  
- **Frameworks / Lib :** React, Vue.js, Node.js, Flask, Tkinter  
- **Bases de données :** MySQL, MongoDB, Supabase  
- **Outils :** Git, GitHub, GitLab  
- **Méthodes :** Développement full stack, API REST, automatisation, CI/CD  

---

## 📞 Contact
- **Email :** f.makha.sar@gmail.com  
- **Téléphone :** 07 68 21 37 89  
- **GitHub :** [Buzz30Gotcho](https://github.com/Buzz30Gotcho)  
- **LinkedIn :** [Sar Frédéric](https://www.linkedin.com/in/freder)
